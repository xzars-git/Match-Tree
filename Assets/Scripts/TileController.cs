...
public class TileController : MonoBehaviour
{
    ...
    private readonly Vector2 sizeBig = Vector2.one * 1.2f;
    private readonly Vector2 sizeSmall = Vector2.zero;
    private readonly Vector2 sizeNormal = Vector2.one;
        ...
        else
        {
            ...
            else
            {
                ...
                if (GetAllAdjacentTiles().Contains(previousSelected))
                {
                    ...
                    {
                        SoundManager.Instance.PlayerWrong();
                        SwapTile(otherTile);
                    }
                });
            }
